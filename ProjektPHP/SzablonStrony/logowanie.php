...
<html lang="pl">
  ...
  <div class="row rowek sticky-top">
    ...
    <div class="col-4 col-xl-3">
        <button type="button" class="buttn btn btn-primary"><img src="grafika/login.png" alt="Logowanie"></button>
    </div>
    <div class="col-4 col-xl-3">
      <a href="rejestracja.php">  <button type="button" class="buttn btn btn-primary"><img src="grafika/register.png" alt="Rejestracja" ></button> </a>
    </div>
